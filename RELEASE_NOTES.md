...
Protoplug 1.6.0 focuses on packaging clarity and larger channel layouts.
...
- Fixed the release package scripts and GitHub Actions artifact uploads so they follow the current version automatically.
...
- Updated plugin metadata and user-visible welcome text to version 1.6.0.
